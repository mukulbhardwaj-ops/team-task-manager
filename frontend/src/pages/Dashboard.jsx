...
export default function Dashboard() {
    ...
    useEffect(() => {
        ...
        const bs = Array.from({ length: 2 }, (_, i) => ({
            id: i,
            x: Math.random() * 80 + 5,
            y: Math.random() * 80 + 5,
    ...
    return (
        ...
        @keyframes fly3 {
          ...
          10%  { opacity: 0.6; }
          35%  { transform: translate(-150px, -60px) rotate(10deg); }
          65%  { transform: translate(-80px, 80px) rotate(-20deg); }
          90%  { opacity: 0.4; }
        ...
        @keyframes fly4 {
          0%   { transform: translate(0, 0) rotate(0deg); opacity: 0; }
          20%  { opacity: 0.6; }
          45%  { transform: translate(100px, -100px) rotate(15deg); }
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
                ...
                <div style={{ padding: "32px" }}>
                    <div style={{ marginBottom: 28 }}>
                        <h2 style={{ color: "white", margin: 0, fontSize: 24, fontWeight: "bold" }}>
                    ...
                    <div style={{ marginTop: 32, maxWidth: 500, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: "20px 24px" }}>
